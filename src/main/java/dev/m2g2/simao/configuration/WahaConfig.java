...
public class WahaConfig {
    ...
    private WahaSessionConfig getWahaSessionConfigRequestDto() {
        List<WahaSessionConfig.Webhook> webhooks = List.of(new WahaSessionConfig.Webhook(host + "/whatsapp/message", List.of("message.any"), List.of(new WahaSessionConfig.CustomHeader("X-Webhook-Secret", webhookSecret))));
